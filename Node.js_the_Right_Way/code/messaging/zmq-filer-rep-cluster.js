...
if (cluster.isMaster) {
  ...
  let
    router = zmq.socket('router').bind('tcp://127.0.0.1:5433'),                 //This will listening to requests with TCPIP protocolls.
    dealer = zmq.socket('dealer').bind('ipc://filer-dealer.ipc');               //IPC protocoll, for communication for unix based computers, this will create an ipc file, ipc protocoll
